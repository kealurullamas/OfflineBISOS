...
<head>
  ...
  <link href="<?php echo base_url('assets/lib/ionicons/css/ionicons.min.css')?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/css/news_carousel.css')?>" rel="stylesheet">
  <link href="<?php echo base_url('assets/css/photo_gallery.css')?>" rel="stylesheet">
        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="">About Us</a>
            <ul>
              ...
              <li><a href="#">Barangay Council</a></li>
